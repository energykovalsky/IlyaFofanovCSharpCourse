...
namespace CSharpCourse
{
    static class Program
    {
        ...
        static void DateTimeIntro()
        {
            ...
            Console.WriteLine(newDt); //29.02.2016 0:00:00
        ...
        static void MathDemo()                  //027 Класс Math.mp4                        
        {
        ...
        static void Comments()                  //026 Комментарии.mp4                       
        {
        ...
        static void CastingAndParsing()         //025 Приведение типов и парсинг.mp4        
        {
            byte b = 3; // 0000 0011
        ...
        static void ConsoleBasics()             //024 Работаем с консолью.mp4               
        {
        ...
        static void ComparingStrings()          //023 Сравнение строк.mp4                   
        {
            //string str1 = "abcde";
            //string str2 = "abcde";
        ...
        static void StringFormat()              //022 Форматирование строк.mp4              
        {
            string name = "John";
            int age = 30;
        ...
        static void StringBuilderDemo()         //021 StringBuilder.mp4                     
        {
        ...
        static void StringModification()        //020 Изменение строк.mp4                   
        {
        ...
        static void StringEmptiness()           //019 Пустота строк.mp4                     
        {
        ...
        static void QueryingStrings()           //018 Базовый API для работы со строками.mp4
        {
        ...
        static void StaticAndInstanceMembers()  //017 Экземплярные и статические методы.mp4 
        {
            string name = "abracadabra";
            bool containsA = name.Contains('a');
            bool containsE = name.Contains('E');
        ...
        static void ComparisonOperators()       //016 Алгебраические операции.mp4 (3)       
        {
            int x = 1;
            int y = 2;
        ...
        static void MathOperations()            //016 Алгебраические операции.mp4 (2)       
        {
            int x = 1;
            int y = 2;
